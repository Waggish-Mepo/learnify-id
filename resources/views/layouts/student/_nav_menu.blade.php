<div class="d-flex py-2">
    <div class="d-flex align-items-center justify-content-center">
        ...
        <div class="font-weight-bold ml-1">{!! $experience->current_xp !!} XP</div>
    </div>
    <div class="d-flex align-items-center ml-2">
        <div class="d-flex align-items-center justify-content-center w-auto px-2 py-2 bg-warning rounded cursor-pointer" data-toggle="tooltip" data-placement="top" title="level XP"><span class="text-white font-weight-bold">Level {!! $experience->level !!}</span></div>
