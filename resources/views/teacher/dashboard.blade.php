...
<div class="block-header">
    ...
    <div class="row-clearfix mt-3">
        ...
        <div class="d-flex justify-content-between mt-3 align-items-end font-weight-bold">
            ...
            <a href="{{ route('subject', ['subject_id' => 'matematika']) }}" class="color-blue-2">Lihat Semua</a>
        </div>
        <div class="mt-3">
            <a href="{{ route('subject.course', ['subject_id' => 'matematika','course_id' => 1]) }}" class="d-flex align-items-center p-2 w-100 bg-white shadow-sm rounded border-hover">
    ...
    <div class="row-clearfix mt-5">
        ...
        <div class="d-flex justify-content-between mt-3 align-items-end font-weight-bold">
            ...
            <a href="{{ route('subject', ['subject_id' => 'bahasa_indonesia']) }}" class="color-blue-2">Lihat Semua</a>
        </div>
        <div class="mt-3">
            <a href="{{ route('subject.course', ['subject_id' => 'bahasa_indonesia','course_id' => 2]) }}" class="d-flex align-items-center p-2 w-100 bg-white shadow-sm rounded border-hover">
                <div class="d-flex align-items-center justify-content-center w35 bg-blue-2 rounded-circle cursor-pointer ml-2" data-toggle="tooltip" data-placement="top" title="materi"><i class="icon-book-open text-white"></i></div>
                <div class="ml-3">
