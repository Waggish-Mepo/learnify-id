...
<div class="block-header px-4">
    ...
    <div class="d-flex">
        ...
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/exam/'.'1'.'/2') }}" class="btn btn-light shadow rounded ml-3">Selanjutnya<i class="fa fa-chevron-right ml-2"></i></a>
    </div>
</div>
@endsection
