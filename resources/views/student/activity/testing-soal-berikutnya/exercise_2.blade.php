...
<div class="block-header px-4">
    <div class="d-flex flex-column m-auto pt-5">
        ...
        <div class="h-auto p-4 mt-3 w-100 bg-white shadow-sm rounded">
            ...
            <div class="py-2 w-md-50 w-100 m-auto">
                <img src="{{asset('assets/images/result_c.svg')}}" width="150" class="d-block m-auto">
    ...
    <div class="d-flex">
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/activity/'.'1') }}" class="btn btn-light shadow rounded"><i class="fa fa-chevron-left mr-2"></i>Sebelumnya</a>
        {{-- ini href nya buat testing ke soal selanjutnya. nnti index selanjutnya dr ini di hapus aja okeyy --}}
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/activity/'.'1'.'/3') }}" class="btn btn-light shadow rounded ml-3">Selanjutnya<i class="fa fa-chevron-right ml-2"></i></a>
    </div>
</div>
@endsection
