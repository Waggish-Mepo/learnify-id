...
<div class="block-header px-4">
    ...
    <div class="d-flex">
        ...
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/activity/'.'1'.'/result') }}" class="btn btn-success shadow rounded ml-3">Kumpulkan<i class="fa fa-chevron-right ml-2"></i></a>
    </div>
</div>
@endsection
