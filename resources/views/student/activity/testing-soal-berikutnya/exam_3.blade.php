...
<div class="block-header px-4">
    ...
    <div class="d-flex">
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/exam/'.'1'.'/2') }}" class="btn btn-light shadow rounded"><i class="fa fa-chevron-left mr-2"></i>Sebelumnya</a>
        {{-- ini href nya buat testing ke soal selanjutnya. nnti index selanjutnya dr ini di hapus aja okeyy --}}
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/exam/'.'1'.'/result') }}" class="btn btn-success shadow rounded ml-3">Kumpulkan<i class="fa fa-chevron-right ml-2"></i></a>
    </div>
</div>
@endsection
