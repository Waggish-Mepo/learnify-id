...
<div class="block-header px-4">
    <div class="d-flex flex-column m-auto pt-5">
        <h3 class="text-capitalize text-white text-center">materi bentuk-bentuk aljabar | ulangan harian 1</h3>
        <div class="h-auto p-4 mt-3 w-100 bg-white shadow-sm rounded">
            <div class="d-flex justify-content-between mb-4">
                <div>
                    <div class="d-flex align-items-center justify-content-center w35 bg-blue-2 rounded-circle cursor-pointer ml-2 text-white" data-toggle="tooltip" data-placement="top" title="materi"><span class="font-weight-bold">2</span>/3</div>
                </div>
                <div class="bg-blue-2 px-3 py-2 rounded text-white">
                    30.00
                </div>
                <div>
    ...
    <div class="d-flex">
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/exam/'.'1') }}" class="btn btn-light shadow rounded"><i class="fa fa-chevron-left mr-2"></i>Sebelumnya</a>
        {{-- ini href nya buat testing ke soal selanjutnya. nnti index selanjutnya dr ini di hapus aja okeyy --}}
        <a href="{{ url('/student/subject/'.'matematika'.'/course/'.'1'.'/topic/'.'1'.'/exam/'.'1'.'/3') }}" class="btn btn-light shadow rounded ml-3">Selanjutnya<i class="fa fa-chevron-right ml-2"></i></a>
    </div>
</div>
@endsection
